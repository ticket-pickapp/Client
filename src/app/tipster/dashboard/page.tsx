      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-3xl font-bold mb-2">Dashboard del Tipster</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <Card className="border-[#2d4057] shadow-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm  mb-1">Ganancias Totales</p>
                        <p className="text-2xl font-bold text-[#00b87a]">
                          €{tipsterStats.totalEarnings}
                        </p>
                      </div>
                ...
                <Card className="border-[#2d4057] shadow-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm  mb-1">Picks Activos</p>
                        <p className="text-2xl font-bold text-[#f7b928]">
                          {tipsterStats.monthlyPicks}
                        </p>
                      </div>
                ...
                <Card className="border-[#2d4057] shadow-sm">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm  mb-1">Suscriptores</p>
                        <p className="text-2xl font-bold text-[#1e9df1]">
                          {tipsterStats.activeSubscribers}
                        </p>
                      </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="">Total de Picks:</span>
                        <span className="font-medium">
                          {tipsterStats.totalPicks}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="">Porcentaje de Acierto:</span>
                        <span className="font-medium text-[#00b87a]">
                          {tipsterStats.winRate}%
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="">Cuota Promedio:</span>
                        <span className="font-medium">
                          {tipsterStats.averageOdds}
                        </span>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-[#2d4057] shadow-sm">
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <Button variant="outline" className="w-full dark:hover:text-white">
                        Ver Mis Picks
                      </Button>
                      <Button variant="outline" className="w-full dark:hover:text-white">
